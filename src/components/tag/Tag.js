    ...
    return (
        <div style={{ transform: 'scale(0.8)' }}>
            <NameBorder
                ...
                left='50px'
                top='20px'
                after={<p style={{ position: 'relative', top: '-25px' }}>{props.name}</p>}
            ...
            <IconStyle
                ...
                after={<img style={{ height: `80%`, width: `80%`, marginTop: `10%`, borderRadius: `50%`, objectFit: 'cover' }} src={props.image}></img>}
            /></div>
    )
}
